        ...
        <SidebarMenu className="app-sidebar__menu">
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              className="group hover:bg-customgreys-secondarybg focus:bg-transparent active:bg-transparent"
            >
              <div className="app-sidebar__logo-container group">
                <div className="app-sidebar__logo-wrapper">
                  ...
                  />
                  <p className="app-sidebar__title text-white-100">LEARNQUEST </p>
                </div>
            ...
            return (
              ...
              >
                <SidebarMenuButton
                  ...
                  size="lg"
                  className={cn(
                    "app-sidebar__nav-button hover:bg-customgreys-secondarybg focus:bg-transparent active:bg-transparent",
