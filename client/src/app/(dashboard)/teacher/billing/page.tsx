        ...
        <div className="billing__filters">
          <Select value={paymentType} onValueChange={setPaymentType}>
            ...
            <SelectContent className="billing__select-content">
              <SelectItem className="billing__select-item text-white-100" value="all">
                All Types
              </SelectItem>
              <SelectItem className="billing__select-item text-white-100" value="stripe">
                Stripe
              </SelectItem>
              <SelectItem className="billing__select-item text-white-100" value="paypal">
                Paypal
              </SelectItem>
            </SelectContent>
          </Select>
